...
author: "R. Juozaitienė, F. Bianchi, M. Boschi, E. Filippi-Mazzola, E. C. Wit"
date: "2024-06-24"
output: pdf_document
---
...
For each observed event, we need to sample one non-event. This means that from the full risk set, we sample one event that does not match the observed event at that time.
