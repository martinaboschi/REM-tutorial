...
same.gender <- (class$info$male[class$rev$sender] == class$info$male[class$rev$receiver]) -        (class$info$male[class$rev$non.sender] == class$info$male[class$rev$non.receiver]) 
